...
const GuestInformation: React.FC = () => {
  ...
  return (
    ...
    <div className="">
      <h3 className="text-lg font-semibold ml-1 mb-2">Guest Information</h3>

      <div className="w-full md:w-[628px] border border-gray-300 rounded-lg p-6 space-y-4">
            {/* Notification */}
      <div className="bg-blue-100 border border-[#023E8A] px-4 py-2 rounded-lg flex items-center gap-3">
        ...
        <p>Guests checking into hotel rooms must be 21 or older and should present a valid photo ID card.</p>
      </div>
