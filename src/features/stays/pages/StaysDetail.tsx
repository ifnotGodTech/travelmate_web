...
const StaysDetail: React.FC = () => {
    ...
    const getCancellationPolicy = () => {
        ...
        return `Fully refundable until ${cancelDate.toLocaleDateString()} at ${cancelDate.toLocaleTimeString([], {hour: '2-digit', minute:'2-digit'})}`;
    };
    ...
    const amenities = selectedHotel?.amenities?.slice(0, 10).map(amenity => ({
            ...
            <section id="Select a room" className="mt-10">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    availableRooms.map((room) => {
                        ...
                        return (
                        <div key={room.code} className="w-full sm:w-[411px] h-auto bg-white shadow-lg rounded-lg p-4 border border-gray-200">
                            ...
                            {/* Room Details */}
                            <div className="mt-4">
                            <h3 className="text-lg font-bold">{room.description || "Standard Room"}</h3>
