    ...
    <div>
      ...
      <div className="lg:pt-24 pt-20">
        <div className="flex justify-normal items-center gap-2 cursor-pointer lg:pl-16 pl-10 border-b border-b-neutral-200 pb-5">
          <Link to="/" className=" p-[8px] bg-white border-[0.5px] border-[#EBECED] shadow-md rounded-[4px] ">
        ...
        <main className="flex flex-col gap-3 items-center justify-center mt-20 lg:px-32 px-8 text-center">
          ...
          <button className="rounded-lg cursor-pointer p-2 w-[inherit] min-w-full hover:bg-[#598fd6] bg-[#023E8A] text-white mt-12">Try Again</button>
          <button className="rounded-lg cursor-pointer p-2 w-[inherit] min-w-full text-[#023E8A] border border-[#023E8A]"><Link to="/">Back to home</Link></button>
        </main>
      </div>
      <div className="mt-24">
        <Footer />
