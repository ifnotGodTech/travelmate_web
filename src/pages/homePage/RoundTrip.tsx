...
const RoundTrip: React.FC = () => {
  ...
  const [passengerAnchor, setPassengerAnchor] = useState<null | HTMLElement>(
    null
  );
  ...
  const addFlight = () => {
    setFlights([
      ...flights,
      { id: flights.length + 1, from: "", to: "", date: "" },
    ]);
  };
    ...
    try {
      const response = await axios.get(
        `https://wft-geo-db.p.rapidapi.com/v1/geo/cities`,
        {
          ...
          headers: {
            "X-RapidAPI-Key":
              "f8e601d31bmsh872d32d4d10fddbp1d8eeajsn162587dd4b51",
        ...
        <div>
          {isMobile ? (
            <Box sx={{ width: "100%" }}>
              ...
              >
                <label htmlFor="from" className="mb-1 text-[16px] font-medium">
                  From
                </label>
                <TextField
                  id="from"
                ...
                >
                  ...
                  >
                    <div className="mb-6">
                      <IconButton
                        sx={{ position: "absolute", left: "28px", top: "15px" }}
                      ...
                      <p className="text-center font-medium text-[20px] mt-[-20px]">
                        From
                      </p>
                    </div>
              ...
              >
                <label htmlFor="to" className="mb-1 text-[16px] font-medium">
                  To
                </label>
                <TextField
                  id="to"
                    ...
                    <div style={{ width: "100%" }}>
                      ...
                      <div className="w-[100%] pb-20">
                        ...
                        <button
                          ...
                          style={{
                            backgroundColor: dateRange[0].startDate
                              ? "#023E8A"
                              : "#B0B0B0",
                            color: "white",
                            marginTop: 2,
                            cursor: dateRange[0].startDate
                              ? "pointer"
                              : "not-allowed",
                          }}
              ...
              >
                <label htmlFor="class" className="mb-1 text-[16px] font-medium">
                  Class
                </label>
                <TextField
                  id="class"
              ...
              <div
                ...
                className="bg-[#023E8A] h-[52px] w-full text-center text-white font-inter text-base rounded-[8px] pt-[14px] mt-[18px] cursor-pointer"
              >
            ...
            <Box sx={{ display: "flex", flexWrap: "wrap", gap: 2 }}>
              ...
              <Box sx={{ display: "flex", flexDirection: "column" }}>
                ...
                >
                  <ClickAwayListener
                    onClickAway={() => setPassengerAnchor(null)}
                  >
                    <Paper
                      elevation={3}
                      sx={{
              ...
              <div
                onClick={handleSearch}
                className="bg-[#023E8A] h-[52px] w-[138px] text-center text-white font-inter text-base rounded-[8px] pt-[14px] mt-[18px] cursor-pointer"
              >
                <button>Search</button>
              </div>
            </Box>
              ...
              <div className="mt-[16px]">
                <div>
                  ...
                  <div className="flex justify-end">
                    <div
                      className="flex mt-[10px] text-[#023E8A] cursor-pointer"
                      onClick={addFlight}
                    >
                      <AddOutlinedIcon />
                      <p>Add Flight</p>
            ...
            <div>
              ...
              >
                ...
                <Box sx={{ display: "flex", flexDirection: "column" }}>
                  ...
                  >
                    <ClickAwayListener
                      onClickAway={() => setFlightClass(false)}
                    >
                      <Paper
                        elevation={3}
                        sx={{
              ...
              <div className="mt-[16px]">
                <div>
                  ...
                  <div className="flex justify-between">
                    <div
                      className="flex mt-[28px] text-[#023E8A] cursor-pointer"
                      onClick={addFlight}
                    >
                      <AddOutlinedIcon />
                      <p>Add Flight</p>
