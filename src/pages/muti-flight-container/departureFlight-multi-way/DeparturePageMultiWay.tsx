  ...
  <div><Navbar/></div>
    <div> 
        ...
        <div className="mt-[16px]">
          ...
          <div className="border border-[#023E8A] w-full bg-[#CCD8E81A] py-2.5 px-2 rounded-lg">
            <div className="flex justify-between gap-2">
              <div className="text-[#181818]">
                {multitripData?.flights?.length > 0 ? (
                  <>
                    <p className="text-[16px] font-medium">
                      {multitripData.flights[0].from} to {multitripData.flights[0].to}
                    </p>
                    <p className="text-[14px] font-normal text-gray-500">
                      {multitripData.flights[0].date}, {multitripData.passengers}
                    </p>
                  </>
                ) : (
