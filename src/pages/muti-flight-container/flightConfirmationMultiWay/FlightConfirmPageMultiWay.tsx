          ...
          <div>
            ...
            <div className="w-[90%] m-auto">
              ...
              <div className="flex justify-between">
                <p className="text-[#4E4F52] text-[14px] font-normal mb-2">
                  {" "}
                  Booking Reference
                </p>
            ...
            <div className="w-[90%] m-auto">
              <div className="">
                <p className="text-[16px] font-medium text-[#181818] mb-[16px]">
                  Passenger Details
                </p>
              </div>
              ...
              <div>
                <div>
                  <div className="flex gap-[4px] mb-[10px]">
                    ...
                    <p className="text-[#181818] text-[14px] mt-[3px]">
                      Air Peace
                    </p>
                  </div>

                  <div className="flex justify-between mb-[10px]">
                    <p className="text-[#181818] text-[14px] font-semibold">
                      2:00pm
                    </p>
            ...
            <div className="w-[90%] m-auto ">
              ...
              <div>
                <div className="">
                  ...
                  <div className="flex justify-between mb-[10px]">
                    <p className="text-[#4E4F52] text-[14px] font-medium">
                      2:00pm
                    </p>
                    <img src={line3} alt="" className="w-[60%] mt-4 " />
                ...
                <div className="flex flex-col gap-1">
                  <div className="flex justify-between">
                    <div>
                      ...
                      <p className="text-[12px] font-inter font-normal text-[#4E4F52]">
                        1 Passenger
                      </p>
                    </div>
                    <div>
                  ...
                  <div className="flex justify-between">
                    ...
                    <div>
                      <p className="text-[#181818] text-[1px] font-inter">
                        ₦40,000
                      </p>
                    </div>
                  </div>
              ...
              <div className="mb-[32px]">
                <div className="border-1 border-[#2D9C5E] w-full bg-[#D5EBDF4D] pt-[16px] pb-[16px] pr-[12px] pl-[12px] rounded-[8px]">
                  <div className="flex gap-2">
                    ...
                    <div>
                      Payment Successful and Your flight is confirmed. E-ticket
                      has been sent to elvis@gmail.com
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div className="mt-[16px]">
                    ...
                    <div>
                      <div className="border border-[#CDCED1] w-[43.6vw] p-[24px] rounded-[12px]">
                        <div className="flex gap-[4px] mb-[10px]">
                          <img src={airlogo} alt="" />
                          <p className="text-[#181818] text-[18px] mt-[5px]">
                            Air Peace
                          </p>
                        </div>

                        <div className="flex justify-between mb-[10px]">
                          <p className="text-[#4E4F52] text-[18px] font-medium">
                            2:00pm
                          </p>
                          <img src={line3} alt="" />
                          <p className="text-[#181818] text-[18px] font-medium">
                            4:00pm
                          </p>
                        </div>
