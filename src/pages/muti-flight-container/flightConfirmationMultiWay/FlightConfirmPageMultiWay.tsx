...
{isMobile ? (
 <div>
        ...
        <div className='w-[90%] m-auto mt-[90px] flex justify-between'>
            ...
            <div className='w-[90%] m-auto '>
            <div>
            <p className='text-[16px] font-medium text-[#181818] mb-[16px]'>Departure Flight 1</p>
            </div>
            ...
            <div className='w-[90%] m-auto '>
            <div>
            <p className='text-[16px] font-medium text-[#181818] mb-[16px]'>Departure Flight 2</p>
            </div>
          ...
          <div className="w-[90%] m-auto ">
                    <p className="text-[16px] font-inter font-medium text-[#181818]">Price Summary</p>
                     <div className="">
                        ...
                        <div className="flex justify-between">
                            <div>
                            <p className="text-[14px] font-inter font-normal text-[#4E4F52]">Departure Flight 1</p>
                        ...
                        <div className="flex justify-between">
                            <div>
                            <p className="text-[14px] font-inter font-normal text-[#4E4F52]">Departure Flight 2</p>
                            <p className="text-[12px] font-inter font-normal text-[#4E4F52]">1 Passenger</p>
                            </div>
