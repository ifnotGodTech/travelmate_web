        ...
        <div className='mb-[20px] mt-[20px] w-[90%] m-auto'>
            ...
            <div className='w-full mb-[24px] border-1 border-[#023E8A] bg-[#CCD8E81A] rounded-[6px] '>
                    ...
                    <div className='items-center p-2'>
                        <p className='text-[16px] text-[#181818] font-inter font-normal'>Multi Way</p>
                ...
                <div className='w-[90%] m-auto'>
                         <p className="text-[18px] font-inter font-medium text-[#181818]">Departure Flight 1</p>
                ...
                <div className='mt-[20px] w-[90%] m-auto'>
                         <p className="text-[18px] font-inter font-medium text-[#181818]">Departure Flight 2</p>
                         <div className='border border-[#CDCED1] rounded-[10px] w-[100%] p-[20px] mt-[20px]'>
                            <div>
                                <div className="flex flex-col gap-2">
                                            <div className='flex gap-[4px] justify-between'>
                    ...
                    <div className="w-[100%]  mt-[20px]">
                        ...
                        <div className="flex justify-between">
                            <div>
                            <p className="text-[18px] font-inter font-normal text-[#4E4F52]">Departure Flight 1</p>
                        ...
                        <div className="flex justify-between">
                            <div>
                            <p className="text-[18px] font-inter font-normal text-[#4E4F52]">Departure Flight 2</p>
                            <p className="text-[14px] font-inter font-normal text-[#4E4F52]">1 Passenger</p>
                            </div>
                            <div><p className="text-[#181818] text-[16px] font-inter">₦40,000</p></div>
                        </div>
