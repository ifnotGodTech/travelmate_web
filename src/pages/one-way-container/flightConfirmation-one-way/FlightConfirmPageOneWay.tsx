         ...
         {isMobile ? (
             ...
             <div>
                    ...
                    <div className='w-[90%] m-auto mt-[90px] flex justify-between'>
                      ...
                      <div className="w-[90%] m-auto ">
                                <p className="text-[16px] font-inter font-medium text-[#181818] mb-[16px]">Price Summary</p>
                                 <div className="">
                                    ...
                                    <div className="flex justify-between">
                                        ...
                                        <p className='text-[#023E8A] text-[14px] font-semibold'>₦80,000</p>
                                    </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <Divider sx={{marginTop:"110px", marginBottom:"30px"}}/>
